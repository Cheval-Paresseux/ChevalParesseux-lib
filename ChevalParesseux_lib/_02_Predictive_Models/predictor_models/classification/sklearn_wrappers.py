...
#! ==================================================================================== #
#! ================================ Tree Classifiers ================================== #
class SKL_tree_classifier(com.Classification_Model):
    """
...
#*____________________________________________________________________________________ #
class SKL_randomForest_classifier(com.Classification_Model):
    """
    ...
    def predict(
        ...
        # ======= II. Predictions =======
        preds_probas = self.random_forest.predict_proba(X)
        
        # ======= III. Raw Predictions =======
        class_order = self.random_forest.classes_
        predicted_class_indices = np.argmax(preds_probas, axis=1)
        predicted_labels = class_order[predicted_class_indices]
...
#*____________________________________________________________________________________ #
class SKL_logisticRegression_classifier(com.Classification_Model):
    """
