...
class CointegrationFeature(cm.Feature):
    def __init__(
        self, 
        ...
        if smoothing_method is not None:
            ...
            for col in self.processed_data.columns:
                ...
                if smoothing_method == "ewma":
                    smoothed_series = aux.ewma_smoothing(price_series=series, window=window_smooth, ind_lambda=lambda_smooth)

                elif smoothing_method == "average":
                    smoothed_series = aux.average_smoothing(price_series=series, window=window_smooth)
    ...
    def get_feature(
        ...
        for i in range(num_obs):
            ...
            beta, intercept, adf_results, kpss_results, residuals = aux.get_cointegration(series_1=series1_window, series_2=series2_window)
