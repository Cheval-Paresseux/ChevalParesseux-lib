...
class Portfolio(ABC):
    """
    Abstract base class for all portfolio optimizations.
    
    This class defines the core structure and interface for portfolio extraction. It is meant to be subclassed
    by specific portfolio optimization implementations. 
    ...
    def set_params(
        ...
        **kwargs
        ...
        """
        Sets the parameter grid for the portfolio extraction.
    ...
    def get_portfolio(
        ...
        **kwargs
        ...
        Parameters:
            - data (tuple | pd.DataFrame): The input data to extract the portfolio from
            - **kwargs: Additional parameters for the portfolio extraction.
        
        Returns:
            - pd.DataFrame : The extracted portfolio as a pd.DataFrame.
        """
        ...
    ...
    def smooth_data(
        ...
        """
        Applies optional smoothing to the input data before portfolio computation.
    ...
    def extract(
        ...
        """
        Main method to extract portfolio.

        Parameters:
            - data (tuple | pd.DataFrame): The input data to extract the portfolio from.
        
        Returns:
            - portfolio_df (pd.DataFrame): The extracted portfolio as a DataFrame.
        """
