...
# ==================================================================================== #
# ================================ Labelling Process ================================= #
def stabilize_labels(label_series: pd.Series, window: int):
    ...
    auxiliary_df["label"] = auxiliary_df.apply(
        lambda row: row["label"] if group_sizes[row.name] >= window else 0,
        axis=1,
    )

    return auxiliary_df["label"]
