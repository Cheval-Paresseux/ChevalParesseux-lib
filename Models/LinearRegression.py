...
#! ==================================================================================== #
#! ================================ Regression Models ================================= #
class OLSRegression(aux.ML_Model):
    def __init__(self):
        # --- Data Fitted ---
        self.X_train = None
        self.y_train = None
    ...
    def fit(self, X_train, y_train):
        ...
        self.statistics, self.residuals = aux.get_regression_stats(train_predictions, X, y, self.coefficients)
...
#*____________________________________________________________________________________ #
class MSERegression(aux.ML_Model):
    def __init__(self):
        # --- Data Fitted ---
        self.X_train = None
        self.y_train = None
    ...
    def gradient_descent(self, learning_rate: float, epochs: int, features_matrix: np.array, target_vector: np.array):
        ...
        for _ in range(epochs):
            ...
            learningRate = aux.adapt_learning_rate(learningRate, loss, last_loss)
            early_stop = aux.early_stopping(loss, last_loss)
            if early_stop:
                break
            last_loss = loss
...
#*____________________________________________________________________________________ #
class RidgeRegression(aux.ML_Model):
...
#*____________________________________________________________________________________ #
class LassoRegression(aux.ML_Model):
    def __init__(self, lambda_: float = 0.1):
        # --- Data Fitted ---
        self.X_train = None
        self.y_train = None
...
#*____________________________________________________________________________________ #
class ElasticNetRegression(aux.ML_Model):
